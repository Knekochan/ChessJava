...
public class Pawn extends ChessPiece {
    ...
    public Pawn(Color color, Pair<Integer,Integer> index) {
        ...
        this.moveStrategy = new MoveStrategy() {
            ...
            private boolean pawnHit(Pair<Integer, Integer> value) {
                ...
                if (ChessBoard.getInstance().getFieldValue(value).getColor() != Pawn.this.color) {
                    if (Pawn.this.color == Color.WHITE) {
                        //(ChessBoard.getInstance().getFieldValue(value) instanceof King) ezt nem fogadta el
                        if (((ChessBoard.getInstance().getFieldValue(value).getType() != 6) && (value.getKey() == Pawn.this.index.getKey() + 1) && (Pawn.this.index.getKey() != 7)) &&         //királyt nem ütjük le és mindenképp a paraszt elötti sorban kell lennie és az utolsó sorban már nem üthet
                                (((Pawn.this.index.getValue() == 0) && (value.getValue() == Pawn.this.index.getValue() + 1)) ||                  //ha a paraszt a 0. oszlopban van
                                        ((Pawn.this.index.getValue() == 7) && (value.getValue() == Pawn.this.index.getValue() - 1)) ||                  //ha a paraszt a 7.oszlopban van
                                        ((value.getValue() == Pawn.this.index.getValue() + 1) || (value.getValue() == Pawn.this.index.getValue() - 1)))) {    //többi
                    ...
                    //fekete paraszt
                        ...
                        if (((ChessBoard.getInstance().getFieldValue(value).getType() != 6) && (value.getKey() == Pawn.this.index.getKey() - 1) && (value.getValue() != 0)) &&         //királyt nem ütjük le és mindenképp a paraszt elötti sorban kell lennie és az utolsó sorban már nem üthet
                                (((Pawn.this.index.getValue() == 0) && (value.getValue() == Pawn.this.index.getValue() + 1)) ||                   //ha a paraszt a 0. oszlopban van
                                        ((Pawn.this.index.getValue() == 7) && (value.getValue() == Pawn.this.index.getValue() - 1)) ||                   //ha a paraszt a 7.oszlopban van
                                        ((value.getValue() == Pawn.this.index.getValue() + 1) || (value.getValue() == Pawn.this.index.getValue() - 1)))) {     //többi
            ...
            public boolean CanMoveTo(Pair<Integer, Integer> value) {
                ...
                if (ChessBoard.getInstance().getFieldValue(value) == null) {
                    if (Pawn.this.color == Color.WHITE &&
                            Pawn.this.index.getKey() < value.getKey() &&
                            ((Pawn.this.index.getKey() == 1 && Math.abs(Pawn.this.index.getKey() - value.getKey()) <= 2) ||
                                    Math.abs(Pawn.this.index.getKey() - value.getKey()) <= 1)) {
                        return true;
                    } else if (Pawn.this.color == Color.BLACK &&
                            Pawn.this.index.getKey() > value.getKey() &&
                            ((Pawn.this.index.getKey() == 6 && Math.abs(Pawn.this.index.getKey() - value.getKey()) <= 2) ||
                                    Math.abs(Pawn.this.index.getKey() - value.getKey()) <= 1)) {
                        return true;
                    }
                } else {
